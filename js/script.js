...
var word = [["pikachu", "A yellow rat."],["Sonic", "Fastest blue animal alive."],
["Elsa", "An Ice Queen in a famous animated movie"], ["A picture is worth a thousand words",
"An old saying where it describes images interest more people rather than information."], 
["George Washington", "Considered as the first president of the United States of America"], 
["The Great Gatsby", "A famous film that Leonardo Dicaprio appears in and is a book."], 
["Interface Design", " the design of user interfaces for machines and software, such as computers,home appliances, mobile devices, and other electronic devices, with the focus on maximizing usability and the user experience."],
